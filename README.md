...
3. Basic agent is basically compeleted. Now, we need to define our tools, system prompts, etc. 
4. The agent skeleton is now completed. We're now at the point which we want to work on the set of tools we need.